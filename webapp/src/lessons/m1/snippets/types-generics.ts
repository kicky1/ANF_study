...
class AnotherStorage<T extends { id: string }> {  // jak dodamy 'extends { id: string }' to mówimy, że T musi rozszerzać ten typ
  constructor(
    public data: T[]
  ){}
...
const anotherStorage = new AnotherStorage([{id:'1'}])
